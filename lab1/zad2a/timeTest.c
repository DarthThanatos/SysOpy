...
#define testingElementsAmount 2000
...
void testFunction(){
    ...
    printf("element found and deleted: "); cout(findElement(emailToFind)->email); printf("\n");
    ...
    cout("delta time after deleting in reference to last control point: sorting:\n");
    printTimeDelta(afterDeletingListClk - afterSortingClk, &sorting, &deletingList);
    printf("----------------------------------------------------\n");
